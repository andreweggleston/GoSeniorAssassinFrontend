...
describe('Service: Websocket', function () {
  ...
  var mockConfig = {
    'endpoints': {
      'websocket': 'ws://api.seniorassassin.gcommer.com/websocket/',
      'api': 'http://api.seniorassassin.gcommer.com',
    },
  };
  ...
  beforeEach(function () {
    ...
    angular.mock.module('seniorassassin.services', function ($provide) {
