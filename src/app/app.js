...
angular.module('seniorassassin.directives', ['seniorassassin.filters']).directive('whitelist', WhitelistDirective).directive('autofocus', AutofocusDirective);
...
require('./pages/index/main-page.controller');
