...
Various static assets files for the seniorassassin website.

## License

This repository contains assets developed and released by other,
unrelated organizations; along with assets developed by seniorassassin
...
permissions. The two licenses used by seniorassassin-created assets are
...
* **img/icons/material/*.svg**: From Google's Material Design Icons
  ...
  seniorassassin team members to change the color of the icon.

* **img/icons/class/*.svg**: TF2-inspired class icons, contributed by
  seniorassassin team member lyreix under CC-BY-NC-SA-4.0.

* **img/formats/*.jpg**: Contributed by seniorassassin team member lyreix
  under CC-BY-NC-SA-4.0.

* **img/badges/{contributor,moderator}.svg**: Contributed by
  seniorassassin team member retro under CC-BY-NC-SA-4.0.

* **img/badges/administrator.{svg,png}**: PNG contributed by devamar
  under CC-BY-NC-SA-4.0. Vectorized by seniorassassin team member lyreix.

* **img/{,not-}mumble.svg**: From the
  [Mumble](https://github.com/mumble-voip/mumble) project, vectorized
  with slight modifications by seniorassassin team member lyreix. See
  `mumble-license.txt`

* **img/{favicon.ico,logo-*.{svg,png}}**: Contributed by seniorassassin team
  members retro (design) and lyreix (vectorization/coloring) under
  CC-BY-NC-SA-4.0.

* **img/maps/*/*.jpg**: TF2 Map screenshots, contributed by seniorassassin
  team member kevinispwn under CC-BY-NC-SA-4.0.

* **img/header-bg.jpg**: Header background, a TF2 map
  screenshot. Contributed by seniorassassin team member kevinispwn under
  CC-BY-NC-SA-4.0.

* **video/koth_suijin.\***: Header backgrounds, a TF2 map
  video. Contributed by seniorassassin team member kevinispwn under
  CC-BY-NC-SA-4.0.
...
* **img/steam*.svg**: Steam logos, vectorized by seniorassassin team
  member lyreix.
